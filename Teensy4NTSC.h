...
public:
	...
	//// Drawing functions /////////////////////////////////////////////////////////////////////
	// The folling functions can draw shapes in either white (default) or black.
	// Draw a pixel at a specified (x, y) coordinate 		
	void 	pixel(int x, int y, bool black = false);
	// Draw a line from (x0,y0) to (x1,y1) 
	void	line(int x0, int y0, int x1, int y1, bool black = false);
	// Draw a filled or empty rectangle defined by lower left and top right coordinates
	void	rectangle(int x0, int y0, int x1, int y1, bool fill = false, bool black = false);
	// Draw a filled or empty circle defined by a center coordinate and radius
	void	circle(int xc, int yc, int r, bool fill = false, bool black = false);
	// Draw a single character at a specified coordinate.
	void	character(int c, int x, int y, bool black = false);
	// Draw a single string of characters at a specified coordinate.
	void	text(char* s, int x, int y, bool black = false);
